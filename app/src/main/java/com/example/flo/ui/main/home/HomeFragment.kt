...
import com.example.flo.ui.main.home.recommend.RecommendFragment
import com.example.flo.data.entities.RecommendPanel
import com.example.flo.ui.main.home.recommend.RecommendVPAdapter
...
class HomeFragment : Fragment() {
    ...
    private fun initAlbumData() {
        albumDB= SongDatabase.Companion.getInstance(this.requireContext())
    ...
    private fun initTodayAlbumRV() {
        ...
        binding.homeTodayMusicAlbumRv.apply {
            ...
            layoutManager =
                LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false) // 수평 레이아웃으로 설정
        }
    }
